...
import { PartyPopper, Camera, Music } from "lucide-react";
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-lg shadow-soft p-8 md:p-12 mb-12">
          <div className="text-center mb-12">
            <p className="text-3xl font-serif text-gold mb-4">400 KM</p>
            <p className="text-soft-grey">Za do 10 osoba, moguća doplata za više</p>
          </div>
