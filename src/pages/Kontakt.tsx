...
const Kontakt = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Poruka poslana!", description: "Kontaktirat ćemo vas u najkraćem mogućem roku." });
    } catch {
      toast({ title: "Greška", description: "Pokušajte ponovo ili nas kontaktirajte direktno.", variant: "destructive" });
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-warm-white rounded-lg shadow-elegant overflow-hidden">
            ...
            <div className="p-6 sm:p-8 lg:p-12 flex flex-col justify-center">
              ...
              {submitted && (
                <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg border border-green-100 mb-6">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-green-800">Poruka uspješno poslana!</p>
                    <p className="text-sm text-green-600">Kontaktirat ćemo vas u najkraćem mogućem roku.</p>
                  </div>
                </div>
              )}
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" size="lg" disabled={submitting} className="w-full bg-gold hover:bg-gold/90 text-warm-white">
            ...
            <div className="relative h-[300px] sm:h-[400px] lg:h-auto lg:min-h-full bg-muted order-first lg:order-last">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d855.3307997902085!2d18.40358396714662!3d43.85627608862552!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4758c9179f9db2b3%3A0x149e452ae9c3a473!2sThe%20Stage%20Sarajevo!5e0!3m2!1sen!2sba!4v1766357272443!5m2!1sen!2sba"
                width="100%"
                height="100%"
