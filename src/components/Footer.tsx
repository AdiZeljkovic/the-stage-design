...
const Footer = () => {
  ...
  const instagramUrl = settings.instagramUrl || siteContent.general.instagramUrl;
  const tiktokUrl = settings.tiktokUrl || siteContent.general.tiktokUrl;
  const facebookUrl = settings.facebookUrl || siteContent.general.facebookUrl;
  const youtubeUrl = settings.youtubeUrl || siteContent.general.youtubeUrl;
  const phone = settings.phone || siteContent.general.phone;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="flex flex-col items-center gap-6 sm:gap-8">
          ...
          <div className="flex gap-3">
            {instagramUrl && (
              <SocialButton href={instagramUrl} label="Instagram profil The Stage Sarajevo">
                <Instagram className="w-4 h-4" />
              </SocialButton>
            )}
            {tiktokUrl && (
              <SocialButton href={tiktokUrl} label="TikTok profil The Stage Sarajevo">
                <TikTokIcon />
              </SocialButton>
            )}
            {facebookUrl && (
              <SocialButton href={facebookUrl} label="Facebook stranica The Stage Sarajevo">
                <Facebook className="w-4 h-4" />
              </SocialButton>
            )}
            {youtubeUrl && (
              <SocialButton href={youtubeUrl} label="YouTube kanal The Stage Sarajevo">
